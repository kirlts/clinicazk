...
| `src/data/` | **[Static Data]** TypeScript modules with site content. | When updating site copy, specialties, memberships, or FAQs. |
| `src/styles/` | **[Design System]** CSS custom properties and global styles aligned with brand manual. | When modifying visual tokens or global styles. |
| `src/assets/` | **[Static Assets]** Brand logos, images, and icons. | When updating brand assets or images. |
| `src/pages/` | **[Routes]** Astro page components defining URL routes. | When adding or modifying page routes. |
